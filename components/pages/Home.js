...
export default () => (
	<div id="container">
		<section className="noisy">
			...
			<section className="tabs home-tabs" id="home-about-tab">
				<ul id="tab-nav">
					<li className="active"><a href="#quoi" className="simple-button gradient tab-button">Quoi?</a></li>
					<li><a href="#ou" className="simple-button gradient tab-button ">Où?</a></li>
					<li><a href="#comment" className="simple-button gradient tab-button ">Comment?</a></li>
				</ul>
				<div className="tab-zone white-box" id="quoi">
				...
				<div className="tab-zone white-box" id="ou">
					<section className="tab-content">
				...
				<div className="tab-zone white-box" id="comment">
					<section className="tab-content">
